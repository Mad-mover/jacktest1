...
class __$$RiderImplCopyWithImpl<$Res>
  ...
  __$$RiderImplCopyWithImpl(
    _$RiderImpl _value,
    $Res Function(_$RiderImpl) _then,
  ) : super(_value, _then);
...
class _$RiderImpl implements _Rider {
  ...
  @override
  String toString() {
    return 'Rider(id: $id, name: $name, phone: $phone, isActive: $isActive, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, phone, isActive, createdAt);
